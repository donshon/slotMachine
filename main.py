    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if 1 <= lines <= MAX_LINES:
                ...
                print("Lines must be in the range of 1 to " + str(MAX_LINES) + " ")
        else:
            print("Please enter a number")
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"Insufficient balance. Your balance: ${balance} Bet total: ${total_bet}")
        else:
            break
...
def main():
    ...
    while True:
        ...
        keepGoing = input("Press enter to play (q to quit).")
        if keepGoing == "q":
            break
